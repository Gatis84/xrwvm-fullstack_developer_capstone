...
// endpoint that retrieves and returns car documents from the MongoDB
// collection based on the specified dealer ID
...
// endpoint that retrieves and returns car documents based on both dealer ID and car make
...
// endpoint that retrieves and returns car documents based on both dealer ID and car model
...
// endpoint that retrieves and returns car documents based on both dealer ID 
// and mileage constraints as below
// Mileage:
...
// endpoint that retrieves and returns car documents based on both dealer ID 
// and price constraints as below
